  ...
  return (
    <section className="contact-section" id="contact">
      ...
      <div className="contact-grid">
        ...
        <a className="contact-item" href="https://wa.me/qr/A7ZULSBYXLC4H1"><div className="contact-icon"><Phone size={21} strokeWidth={1.5} /></div><div className="contact-item-content"><span>TELEPON</span><strong>+62 895 2408 5083</strong></div><ArrowUpRight className="contact-arrow" size={19} /></a>
